...
import cn.ac.iie.cls.agent.tools.EmailTools;
 ...
 * @author root
 */
public class SubEmailThread implements Runnable {

    private static Logger logger = Logger.getLogger(SubEmailThread.class);
    String name;
    String xml;
    ...
    public void run() {
        ...
        if (protocol.equals("") || address.equals("") || processjobinstanceId.equals("") || operator_id.equals("") || type.equals("") ||/*
                 * ftpip.equals("") ||
                 */ username.equals("") || password.equals("") || hdfsPath.equals("") /*
                 * || port.equals("")
                 */) {
        ...
        EmailTools.downFile(name, protocol, address, username, password, localPath);
        //transfer to HDFS
    ...
    public SubEmailThread(String name, String xml) {
        this.name = name;
        this.xml = xml;
    }
}
