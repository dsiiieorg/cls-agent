...
public class HdfsUpload {
    ...
    private static Logger logger = Logger.getLogger(HdfsUpload.class);

    public void run(String name, String path, String type, String hdfsPath, String task_id, String operator_id, String xml) {
        //get source files
